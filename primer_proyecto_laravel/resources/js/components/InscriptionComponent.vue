                ...
                <div class="flex flex-wrap p-4">
                    ...
                    <div class="w-full md:w-1/4 mb-1 px-4 flex items-center">
                        ...
                        <select v-model="inscribir.ciclo" required title="Seleccione el ciclo" class="shadow border rounded-r-lg w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                            <option v-for="ciclo in ciclos" :value="ciclo" :key="ciclo"> {{ ciclo }} </option>
                        </select>
                    </div>
                    ...
                    <div class="w-full h-1/2 md:w-1/2 mb-1 px-4">
                        ...
                        <div class="w-1/1 p-2 flex flex-wrap border-2 border-gray-400 rounded-b-lg bg-white overflow-auto" style="max-height: 14rem;">
                            <div v-for="materia in materias" :key="materia.id" :class="{'bg-gray-100 border-2': inscribir.materias.length >= inscribir.limit}" class="w-full md:w-1/2 mb-1 px-4 flex items-center rounded-lg hover:bg-gray-100">
                        ...
                        <tr v-for="inscripcion in inscripciones" @click="modificarInscripcion(inscripcion)" :key="inscripcion.idInscription" class="text-black hover:bg-gray-400 duration-500">
                            ...
                            <td class="bg-gray-100 hover:bg-gray-200 duration-500 border-l px-4 py-2">
                                <ul class="list-disc list-outside pl-2">
                                    <li v-for="materia in inscripcion.materias" :key="materia.id" class="text-gray-700 hover:text-black duration-500">{{ materia.name }}, {{ materia.day }}, {{ materia.from }} - {{ materia.to }}</li>
                                </ul>
                            </td>
    ...
    export default {
        ...
        methods: {
            ...
            saveChanges() {
                ...
                // Por cada materia seleccionada se guardara un nuevo registro en la base de datos
